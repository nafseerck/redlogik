...
class LogUtil {
    ...
    static void init(Context context) {
        LogUtil.ISDEBUG = (ApplicationInfo.FLAG_DEBUGGABLE == (context.getApplicationInfo().flags & ApplicationInfo.FLAG_DEBUGGABLE));
    }
     ...
     */
    static void debug(String tag, String text) {
        if (LogUtil.ISDEBUG) {
            Log.d(tag, text);
        }
    }
     ...
     * @param text - Log message
     */
    static void warn(String tag, String text) {
        if (LogUtil.ISDEBUG) {
            Log.w(tag, text);
        }
    }
